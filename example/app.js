...
/***/ function(module, exports, __webpack_require__) {
	...
	'use strict';var _createClass=(function(){function defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||false;descriptor.configurable=true;if("value" in descriptor)descriptor.writable=true;Object.defineProperty(target,descriptor.key,descriptor);}}return function(Constructor,protoProps,staticProps){if(protoProps)defineProperties(Constructor.prototype,protoProps);if(staticProps)defineProperties(Constructor,staticProps);return Constructor;};})();var _react=__webpack_require__(2);var _react2=_interopRequireDefault(_react);var _reactDom=__webpack_require__(159);var _reactDom2=_interopRequireDefault(_reactDom);var _index=__webpack_require__(160);var _index2=_interopRequireDefault(_index);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError("Cannot call a class as a function");}}function _possibleConstructorReturn(self,call){if(!self){throw new ReferenceError("this hasn't been initialised - super() hasn't been called");}return call&&(typeof call==="object"||typeof call==="function")?call:self;}function _inherits(subClass,superClass){if(typeof superClass!=="function"&&superClass!==null){throw new TypeError("Super expression must either be null or a function, not "+typeof superClass);}subClass.prototype=Object.create(superClass&&superClass.prototype,{constructor:{value:subClass,enumerable:false,writable:true,configurable:true}});if(superClass)Object.setPrototypeOf?Object.setPrototypeOf(subClass,superClass):subClass.__proto__=superClass;}var SomeComponent=(function(_React$Component){_inherits(SomeComponent,_React$Component);function SomeComponent(props){_classCallCheck(this,SomeComponent);return _possibleConstructorReturn(this,Object.getPrototypeOf(SomeComponent).call(this,props));}_createClass(SomeComponent,[{key:'componentWillMount',value:function componentWillMount(){this.context.request.getRequest({url:'localhost:3000',endCallback:function endCallback(err,res){}});}},{key:'render',value:function render(){return _react2.default.createElement('span',null,'test');}}]);return SomeComponent;})(_react2.default.Component);SomeComponent.contextTypes={request:_react2.default.PropTypes.object};var App=(function(_React$Component2){_inherits(App,_React$Component2);function App(props){_classCallCheck(this,App);return _possibleConstructorReturn(this,Object.getPrototypeOf(App).call(this,props));}_createClass(App,[{key:'render',value:function render(){return _react2.default.createElement(_index2.default,null,_react2.default.createElement(SomeComponent,null));}}]);return App;})(_react2.default.Component);_reactDom2.default.render(_react2.default.createElement(App,null),document.getElementById('app'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	'use strict';var _createClass=(function(){function defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||false;descriptor.configurable=true;if("value" in descriptor)descriptor.writable=true;Object.defineProperty(target,descriptor.key,descriptor);}}return function(Constructor,protoProps,staticProps){if(protoProps)defineProperties(Constructor.prototype,protoProps);if(staticProps)defineProperties(Constructor,staticProps);return Constructor;};})();Object.defineProperty(exports,"__esModule",{value:true});var _react=__webpack_require__(2);var _react2=_interopRequireDefault(_react);var _request=__webpack_require__(161);var _request2=_interopRequireDefault(_request);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError("Cannot call a class as a function");}}function _possibleConstructorReturn(self,call){if(!self){throw new ReferenceError("this hasn't been initialised - super() hasn't been called");}return call&&(typeof call==="object"||typeof call==="function")?call:self;}function _inherits(subClass,superClass){if(typeof superClass!=="function"&&superClass!==null){throw new TypeError("Super expression must either be null or a function, not "+typeof superClass);}subClass.prototype=Object.create(superClass&&superClass.prototype,{constructor:{value:subClass,enumerable:false,writable:true,configurable:true}});if(superClass)Object.setPrototypeOf?Object.setPrototypeOf(subClass,superClass):subClass.__proto__=superClass;}var ContextAjax=(function(_React$Component){_inherits(ContextAjax,_React$Component);function ContextAjax(props){_classCallCheck(this,ContextAjax);var _this=_possibleConstructorReturn(this,Object.getPrototypeOf(ContextAjax).call(this,props));_this.request=new _request2.default(props);return _this;}_createClass(ContextAjax,[{key:'getChildContext',value:function getChildContext(){return {request:this.request};}},{key:'componentDidMount',value:function componentDidMount(){if(this.props.readyCallback){this.props.readyCallback(this.request);}}},{key:'render',value:function render(){return this.props.children;}}]);return ContextAjax;})(_react2.default.Component);ContextAjax.propTypes={baseUrl:_react2.default.PropTypes.string,timeout:_react2.default.PropTypes.number,type:_react2.default.PropTypes.string,headers:_react2.default.PropTypes.object,readyCallback:_react2.default.PropTypes.func,endCallback:_react2.default.PropTypes.func};ContextAjax.childContextTypes={request:_react2.default.PropTypes.object};exports.default=ContextAjax;

/***/ },
/* 161 */
/***/ function(module, exports, __webpack_require__) {

	'use strict';var _createClass=(function(){function defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||false;descriptor.configurable=true;if("value" in descriptor)descriptor.writable=true;Object.defineProperty(target,descriptor.key,descriptor);}}return function(Constructor,protoProps,staticProps){if(protoProps)defineProperties(Constructor.prototype,protoProps);if(staticProps)defineProperties(Constructor,staticProps);return Constructor;};})();Object.defineProperty(exports,"__esModule",{value:true});var _superagent=__webpack_require__(162);var _superagent2=_interopRequireDefault(_superagent);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError("Cannot call a class as a function");}}var Request=(function(){function Request(){var options=arguments.length<=0||arguments[0]===undefined?{}:arguments[0];_classCallCheck(this,Request);this.baseUrl=options.baseUrl||'';this.timeout=options.timeout;this.type=options.type||'json';this.headers=options.headers||{};this.endCallback=options.endCallback;}_createClass(Request,[{key:'addHeader',value:function addHeader(key,value){this.headers[key]=value;}},{key:'removeHeader',value:function removeHeader(key){delete this.headers[key];}},{key:'_configRequest',value:function _configRequest(request,options){var _this=this;if(this.timeout){request=request.timeout(this.timeout);}if(this.type){request=request.type(this.type);}var headers=Object.assign({},this.headers,options.headers);Object.keys(headers).forEach(function(key){var value=headers[key];if(value!==undefined&&value!==null){request=request.set(key,value);}});var fields=Object.assign({},options.fields);Object.keys(fields).forEach(function(key){var value=fields[key];if(value!==undefined&&value!==null){request=request.field(key,value);}});var attachments=Object.assign({},options.attachments);Object.keys(attachments).forEach(function(key){var value=fields[key];if(value!==undefined&&value!==null){if(value.filename&&value.path){request=request.field(key,value.path,value.filename);}else if(value.path){request=request.attach(key,value.path);}else {request=request.field(key,value);}}});return request.end(function(err,res){var req=options;req.request=_this;if(_this.endCallback&&options.endCallback){_this.endCallback(err,req,res,function(){var newErr=arguments.length<=0||arguments[0]===undefined?err:arguments[0];var newReq=arguments.length<=1||arguments[1]===undefined?req:arguments[1];var newRes=arguments.length<=2||arguments[2]===undefined?res:arguments[2];return options.endCallback(newErr,newReq,newRes);});}else if(_this.endCallback){_this.endCallback(err,req,res,function(){});}else if(options.endCallback){options.endCallback(err,req,res);}});}},{key:'_configUrl',value:function _configUrl(){var url=arguments.length<=0||arguments[0]===undefined?'':arguments[0];return this.baseUrl+url;}},{key:'getRequest',value:function getRequest(){var options=arguments.length<=0||arguments[0]===undefined?{}:arguments[0];this._configRequest(_superagent2.default.get(this._configUrl(options.url)).query(options.query),options);}},{key:'postRequest',value:function postRequest(){var options=arguments.length<=0||arguments[0]===undefined?{}:arguments[0];this._configRequest(_superagent2.default.post(this._configUrl(options.url)).send(options.body).query(options.query),options);}},{key:'putRequest',value:function putRequest(){var options=arguments.length<=0||arguments[0]===undefined?{}:arguments[0];this._configRequest(_superagent2.default.put(this._configUrl(options.url)).send(options.body).query(options.query),options);}},{key:'deleteRequest',value:function deleteRequest(){var options=arguments.length<=0||arguments[0]===undefined?{}:arguments[0];this._configRequest(_superagent2.default.del(this._configUrl(options.url)).query(options.query),options);}},{key:'request',value:function request(){return _superagent2.default;}}]);return Request;})();exports.default=Request;
